  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="admes in addressInfo"
        :key="admes.id"
      >
        <span class="username" :class="{ selected: admes.isDefault == 1 }">{{
          admes.consignee
        }}</span>
        <p @click="changeDefault(admes, addressInfo)">
          <span class="s1">{{ admes.fullAddress }}</span>
          <span class="s2">{{ admes.phoneNum }}</span>
          <span class="s3" v-show="admes.isDefault == 1">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
...
export default {
  ...
  methods: {
    //修改默认地址
    changeDefault(admes, addressInfo) {
